...
param1 = pd.read_csv('experiment-full/acceleration-5.txt', delimiter=',').to_numpy()[:, 0]
param2 = pd.read_csv('experiment-full/acceleration-6.txt', delimiter=',').to_numpy()[:, 0]
param3 = pd.read_csv('experiment-full/acceleration-7.txt', delimiter=',').to_numpy()[:, 0]
param4 = pd.read_csv('experiment-full/acceleration-8.txt', delimiter=',').to_numpy()[:, 0]
param5 = pd.read_csv('experiment-full/acceleration-100.txt', delimiter=',').to_numpy()[:, 0]
...
plt.savefig('report-plots/svg/acceleration-{experiment}.svg'.format(experiment=experiment_type), dpi=1000, bbox_inches='tight')
plt.show()
